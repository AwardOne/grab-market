  ...
  return (
    <div id="upload-container">
      <Form name="상품 업로드" onFinish={onSubmit}>
        ...
        <Divider />
        <Form.Item
          label={<div className="upload-label">판매장명</div>}
          name="seller"
          rules={[{ required: true, message: "이름을입력해주세요" }]}
        >
          <Input
        ...
        <Form.Item
          name="name"
          label={<div lassName="upload-label">상품 이름</div>}
          rules={[{ required: true, message: "상품명을입력해주세요" }]}
          // 필수항목을 표시하는 props이다
        >
          <Input
            className="upload-name"
